...
import aboutwork_1 from "../assets/aboutwork_1.png"
import aboutwork_2 from "../assets/aboutwork_2.png"
  ...
  return (
    <section className='max-w-[1320px] mx-auto py-[80px] bg-white'>
        ...
        <div className='grid sm:grid-cols-2 gap-5 lg:mt-10 mt-3 mx-3 xl:mx-0'>
            <div className='rounded-[13px]  border sm:h-[372px] h-[250px] grid place-items-center text-white group bg-cover ' style={{ backgroundImage: `url(${aboutwork_1})` }} >
            ...
            <div className='rounded-[13px]  border sm:h-[372px] h-[250px] grid place-items-center text-white group bg-cover ' style={{ backgroundImage: `url(${aboutwork_2})` }}>
                <div className='bg-[rgba(30,108,164,0.8)] lg:h-28 h-16 lg:group-hover:h-[50%] group-hover:h-[56%] py-2 w-full text-center overflow-hidden duration-700 group-hover:overflow-visible'>
